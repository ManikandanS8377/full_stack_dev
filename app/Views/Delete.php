...
<body>
    ...
    <content class="content">
        ...
        <form action="<?php echo base_url(); ?>deleteValue" id="Add_Form">
          <p class="response"><?php echo($status);?></p>
          <label for="roll_number" class="add_lable">Roll number:</label><br>
          <input type="text" id="roll_number" name="roll_number" value="" class="add_input"><br><br>

          <input type="submit" class="add_submit" value="Delete Value">
        </form>
    </content>
